...
urlpatterns = [
    ...
    path('register/', views.MultiStepRegistrationView.as_view(), name='registration'),
    ...
    path('registration-success/', views.success_view, name='success_page'), # Changed name='success' to name='success_page'
